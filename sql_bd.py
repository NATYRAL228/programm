...
class DateBaseSQL():
    ...
    def __init__(self, name = None):
        ...
        self.cur = self.con.cursor()# создаёт курсор к которому будет обращаться
    ...
    def set(self, name, score):
        ...
        if score is not None or score > db_score:
            ...
            self.cur.execute(f"INSERT INTO stocks VALUES ('{name}', '{score}')")# вставляем в stonks значения
